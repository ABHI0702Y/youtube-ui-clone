...
import { BsYoutube, BsCameraVideo, BsBell, BsBellFill } from "react-icons/bs";
import { GiHamburgerMenu } from "react-icons/gi";
import { IoAppsSharp } from "react-icons/io5";
import { Link, useLocation, useNavigate } from "react-router-dom";
import { useAppDispatch, useAppSelector } from "../store/hooks";
import { changeSearchTerm, clearSearchTerm, clearVideos, toggleSidebar } from "../store";
  ...
  return (
    <div className="flex justify-between items-center px-14 h-14 bg-[#212121] opacity-95 sticky top-0 z-50">
      <div className="flex gap-8 items-center text-2xl">
        <div
          className="cursor-pointer hover:bg-zinc-700 p-2 rounded-full"
      ...
      <div className="flex items-center justify-center gap-5">
        ...
        <div
          className="text-xl p-3 bg-zinc-900 rounded-full cursor-pointer hover:bg-zinc-700"
